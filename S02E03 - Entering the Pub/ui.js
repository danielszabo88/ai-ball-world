...
document.getElementById("btn-pause").addEventListener("click", (e) => {
  ...
  e.currentTarget.textContent = physicsWorld.paused ? "Play" : "Pause";
});

document.getElementById("speed-slider").addEventListener("input", (e) => {
  physicsWorld.speedMultiplier = SPEED_STEPS[parseInt(e.target.value, 10)];
  document.getElementById("speed-label").textContent =
    physicsWorld.speedMultiplier + "x";
});
...
function buildInspectorDOM(container) {
  ...
  goals.content.innerHTML = `
    ...
    <div class="inspector-row"><span class="key">visit_pub</span><span class="value" id="isp-score-visit_pub"></span></div>
